...
namespace OmniSharp.DotNet
{
    ...
    public class DotNetProjectSystem : IProjectSystem
    {
        ...
        public void Initalize(IConfiguration configuration)
        {
            ...
            _workspaceContext = WorkspaceContext.CreateFrom(_environment.Path, _compilationConfiguration);
        ...
        private void Update()
        {
            ...
            foreach (var state in _projectStates.Values)
            {
                ...
                var lens = new ProjectContextLens(state.ProjectContext, _workspaceContext.Configuration);
        ...
        private void UpdateCompilationOption(ProjectState state)
        {
            ...
            var option = project.GetCompilerOptions(context.TargetFramework, _workspaceContext.Configuration);
